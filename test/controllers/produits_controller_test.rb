...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { nom: @produit.nom, prix: @produit.prix, type_id: @produit.type_id } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { nom: @produit.nom, prix: @produit.prix, type_id: @produit.type_id } }
