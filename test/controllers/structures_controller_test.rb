...
class StructuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create structure" do
    assert_difference('Structure.count') do
      post structures_url, params: { structure: { adresse: @structure.adresse, libelle: @structure.libelle, sigle: @structure.sigle, telephone: @structure.telephone } }
    end
  ...
  test "should update structure" do
    patch structure_url(@structure), params: { structure: { adresse: @structure.adresse, libelle: @structure.libelle, sigle: @structure.sigle, telephone: @structure.telephone } }
